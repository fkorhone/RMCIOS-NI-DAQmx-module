...
#define DAQmx_Dev_AO_TrigUsage                                           0x2987 // Indicates the triggers supported by this device for an analog output task.
...
#define DAQmx_Dev_DI_TrigUsage                                           0x2988 // Indicates the triggers supported by this device for an digital input task.
...
#define DAQmx_Dev_DO_TrigUsage                                           0x2989 // Indicates the triggers supported by this device for an digital output task.
...
#define DAQmx_Dev_CI_TrigUsage                                           0x298A // Indicates the triggers supported by this device for an counter input task.
...
#define DAQmx_Dev_CO_TrigUsage                                           0x298B // Indicates the triggers supported by this device for an counter output task.
